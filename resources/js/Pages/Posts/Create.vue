  ...
  <div class="container mx-auto p-6 bg-white shadow-md rounded-md">
      ...
      <div v-for="(tags,category) in categories" :key="category" class="mb-4">
        ...
        <div class="flex flex-wrap gap-2">
          <span v-for="tag in tags" :key="tag" 
              @click="toggleTag(tag)" 
              :class="selectedTags.includes(tag) ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-800'"
    ...
    <form @submit.prevent="submit">
      ...
      <div class="mb-4">
        ...
        <textarea v-model="form.content" id="content" rows="8" class="mt-1 p-2 block w-full border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"></textarea>
